...
//
//        String firstCName = one.getClass().getSimpleName().toLowerCase();
//        String resCName = resultClassObject.getSimpleName().toLowerCase();
//        String jSon = stringWriter.toString().replaceFirst(firstCName, resCName);
//
