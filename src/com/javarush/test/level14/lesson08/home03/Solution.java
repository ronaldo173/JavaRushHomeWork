...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (!temp.equals("user") && !temp.equals("looser") &&
                    !temp.equals("coder") && !temp.equals("proger")) break;

            if (temp.equals("user")) person = new Person.User();
            else if (temp.equals("coder")) person = new Person.Coder();
            else if (temp.equals("looser")) person = new Person.Looser();
